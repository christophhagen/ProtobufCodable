...
extension DecodingError {
    ...
    static func notSupported(_ message: String, codingPath: [CodingKey]) -> DecodingError {
 ...
 */
    static func missingValue(for key: CodingKey, codingPath: [CodingKey], _ message: String) -> DecodingError {
